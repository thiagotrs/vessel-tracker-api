import ICreateVessel from '../../application/port/ICreateVessel'
import IDeleteVessel from '../../application/port/IDeleteVessel'
import IDockVessel from '../../application/port/IDockVessel'
import IGetAllVessels from '../../application/port/IGetAllVessels'
import IGetVesselById from '../../application/port/IGetVesselById'
import IReplaceAllNextStops from '../../application/port/IReplaceAllNextStops'
import IUndockVessel from '../../application/port/IUndockVessel'
